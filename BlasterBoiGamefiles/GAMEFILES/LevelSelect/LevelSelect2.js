class LevelSelect2 extends Phaser.Scene {
    constructor(){
      super({key:'LevelSelect2'})
    }
    preload(){
      this.load.image('background','GAMEFILES/Assets/Other/background-pixilart.png');
      this.load.image('l6','GAMEFILES/Assets/LevelSelect/level6.png')
      this.load.image('l7','GAMEFILES/Assets/LevelSelect/level7.png')
      this.load.image('l8','GAMEFILES/Assets/LevelSelect/level8.png')
      this.load.image('l9','GAMEFILES/Assets/LevelSelect/level9.png')
      this.load.image('l10','GAMEFILES/Assets/LevelSelect/level10.png')
