class GameScene17 extends Phaser.Scene {
    constructor(){
        super({key:'GameScene17'})
    }
    preload(){
    ...
    create(){
      ...
      let win = false;
      const goal = 850; // unit - score
      const rateOfFire = 690; // unit - ms
      const genEn = 150; // unit - ms
      const rarity = 400; // chance of medpack
      const leveln = 18; // level after this one
      const damage = 1; // damage enemys do
      const currentL = 17; // current level
