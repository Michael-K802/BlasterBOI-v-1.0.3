class GameScene10 extends Phaser.Scene {
    ...
    create(){
      ...
      let win = false;
      const goal = 500; // unit - score
      const rateOfFire = 270; // unit - ms
      const genEn = 110; // unit - ms
      const rarity = 400; // chance of special items
      const leveln = 11; // level after this one
      const damage = 1; // damage enemys do
      const currentL = 10; // current level
