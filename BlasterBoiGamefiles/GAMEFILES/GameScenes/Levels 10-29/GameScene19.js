class GameScene19 extends Phaser.Scene {
    constructor(){
        super({key:'GameScene19'})
    }
    preload(){
      ...
      create(){
        ...
        gameState.scoreText = this.add.text(10,545,`${unit}:${gameState.score}/${goal}`,{fontSize:'20px',fill:'#fdf1da'});
