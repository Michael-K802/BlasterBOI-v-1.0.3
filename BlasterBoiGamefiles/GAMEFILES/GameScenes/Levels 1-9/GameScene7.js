class GameScene7 extends Phaser.Scene {
    ...
    create(){
      ...
      let win = false;
      const goal = 300; // unit - score
      const rateOfFire = 300; // unit - ms
      const genEn = 140; // unit - ms
      const rarity = 400; // chance of medpack
      const leveln = 8; // level after this one
      const damage = 1; // damage enemys do
      const currentL = 7; // current level
      const regenDelay = 4000; // regen rate
